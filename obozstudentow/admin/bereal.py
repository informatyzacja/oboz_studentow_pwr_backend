...
class BeerealPostAdmin(admin.ModelAdmin):
    list_display = ('user', 'bereal_date', 'created_at', 'is_late', 'likes_count', 'photo_preview')
...
class BeerealLikeAdmin(admin.ModelAdmin):
    ...
    search_fields = ('user__first_name', 'user__last_name', 'post__user__first_name', 'post__user__last_name')
    ordering = ('-created_at',)
...
class BeerealReportAdmin(admin.ModelAdmin):
    list_display = ('reporter', 'post_user', 'post_date', 'created_at', 'resolved', 'resolved_by')
    list_filter = ('resolved', 'created_at', 'post__bereal_date')
    search_fields = ('reporter__first_name', 'reporter__last_name', 'post__user__first_name', 'post__user__last_name', 'reason')
    ...
    def mark_resolved(self, request, queryset):
        ...
        self.message_user(request, f'Oznaczono {queryset.count()} zgłoszeń jako rozwiązane.')
